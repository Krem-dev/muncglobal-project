    ...
    >
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Thank you for registering for MUNC-GLOBAL Conference 2027. {paymentData || paymentStatus === 'success' ? 'Your payment has been received.' : 'Please proceed to payment to complete your registration.'}
        </p>
      </div>
        ...
        <ul className="text-left space-y-3">
          ...
          <li className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Mark your calendar for MUNC-GLOBAL Conference 2027. We'll send you reminders as the date approaches.
              </p>
            </div>
          </li>
          <li className="flex items-start">
